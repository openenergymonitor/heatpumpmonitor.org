  ...
  <table width="100%" class="table-hpmon">
    <thead>
      ...
      <tr>
        ...
        <!-- Property -->
        <th @click="sort('location', 'asc')" class="lborder">Location</th>
    ...
    <tbody>
      <template v-for="n in sortedNodes"><tr v-bind:id="'row'+n.id" v-bind:class="hiliteClass(n)">
        ...
        <td v-bind:title="n.insulation">{{n.insulation.split(' ').slice(0, 2).join(' ')}}</td>
...
<script src="views/table.js?v=3.3"></script>
